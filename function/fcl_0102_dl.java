public boolean fcl_0102_dl(String vertifyValue, String...args) {
			...
			if(pl1_flag.equals("1")){
	    		if(pl1_cert_type.equals("2")||pl1_cert_type.equals("8")
	    			||pl1_cert_type.equals("9")||pl1_cert_type.equals("a")||pl1_cert_type.equals("b")){
	    			App.showFlashStateMsg("由于身份类别选择1-中国居民,请将证件类型更改为0,1,7,6");
	    			return false;
	    		}
	    	}else if(pl1_flag.equals("2")){
	        	if(pl1_cert_type.equals("0")||pl1_cert_type.equals("4")
	    			||pl1_cert_type.equals("1")||pl1_cert_type.equals("7")||
	           ...
	           if(pl1_cert_type.equals("0")||pl1_cert_type.equals("1")
	    			||pl1_cert_type.equals("2")||pl1_cert_type.equals("8")||
	           ...
	           if(pl1_cert_type.equals("0")||pl1_cert_type.equals("1")
	    			||pl1_cert_type.equals("2")||pl1_cert_type.equals("6")||
	           ...
	           if(pl1_cert_type.equals("0")||pl1_cert_type.equals("1")
	    			||pl1_cert_type.equals("2")||pl1_cert_type.equals("7")||
	    			pl1_cert_type.equals("8")||pl1_cert_type.equals("9")
