public boolean fun_chk_endbit_4(){
			int sum,i,j,k;
		    String fin_prodno;
		    String pl3_prod_id_1= this.curTranSession.getVariableList().getValue("pl3_prod_id_1");
		    ...
		    for  (i=0;i>=1;i++)
		     { k=pl2_curr_id_4[i]-48;
		      sum=sum + ((sav_chk:j)*k);
		      j=j+1;
		     }
		    
		    if ( pl3_prod_id_1 == null )
		     { fin_prodno = p3_prod_id_2;
		     }
		    else
		     {
		     fin_prodno = pl3_prod_id_1;
		     }
